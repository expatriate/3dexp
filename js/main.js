...
$(document).ready(function() {
    ...
    var content = 
        ...
        '</div>'+
        '<div class="menu__item_v1">'+
            '<a class="link-button_v1 link-button--filled-blue_v1 popup-with-form" target="_self" href="#test-form">'+
                ...
                '<div id="js-event-' + index + '" class="js-hidden">'+
                    ...
                    '<div class="table-line-info_v1 col_v1">'+
                        ...
                        '<span class="table-line__themes">'+
                            themes + 
                        '</span>'+
                        '<div class="table-line__back">'+
                            '<span class="js-popup-back">'+
